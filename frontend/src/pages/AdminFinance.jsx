...
const AdminFinance = () => {
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        if (studentIdInput === '123') {
            setSearchedStudent({
                name: 'Aryan Sharma',
                id: '10A-04',
                class: 'Class 10 - A',
                pendingAmount: 14500,
                dueFor: 'Term 1 Tuition & Transport'
            });
        } else {
    ...
    const handleCollect = () => {
        alert("Offline Fee Collected! Ledger Updated. Receipt Generated.");
        setSearchedStudent({
            ...searchedStudent,
            pendingAmount: 0,
            dueFor: 'Nil'
                ...
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 lg:col-span-1 h-fit">
                    ...
                    <form onSubmit={handleSearch} className="space-y-4">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                placeholder="Enter 11-Digit ID (Use '123')"
                        ...
                        <Button type="submit" className="w-full">Lookup Dues</Button>
                    </form>
                            ...
                            {searchedStudent.pendingAmount > 0 ? (
                                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        <Button variant="outline" className="border-2 hover:bg-primary/5 hover:border-primary/50 text-slate-700">Cash Received</Button>
                                        <Button variant="outline" className="border-2 hover:bg-primary/5 hover:border-primary/50 text-slate-700">Card POS/UPI</Button>
                                        <Button variant="outline" className="col-span-2 border-2 hover:bg-primary/5 hover:border-primary/50 text-slate-700">Bank Transfer / Cheque</Button>
                                    </div>
